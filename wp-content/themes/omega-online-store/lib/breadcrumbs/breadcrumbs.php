 ...
 * @return void
 */
function omega_online_store_breadcrumb_trail( $args = array() ) {

    $breadcrumb = apply_filters( 'omega_online_store_breadcrumb_trail_object', null, $args );
...
class Breadcrumb_Trail {
    ...
    public function __construct( $args = array() ) {
        ...
        $this->args = apply_filters( 'omega_online_store_breadcrumb_trail_args', wp_parse_args( $args, $defaults ) );
    ...
    public function trail() {
        ...
        $breadcrumb = apply_filters( 'omega_online_store_breadcrumb_trail', $breadcrumb, $this->args );
    ...
    protected function set_labels() {
        ...
        $this->labels = apply_filters( 'omega_online_store_breadcrumb_trail_labels', wp_parse_args( $this->args['labels'], $defaults ) );
    }
    ...
    protected function set_post_taxonomy() {
        ...
        $this->post_taxonomy = apply_filters( 'omega_online_store_breadcrumb_trail_post_taxonomy', wp_parse_args( $this->args['post_taxonomy'], $defaults ) );
    }
    ...
    protected function add_items() {
        ...
        $this->items = array_unique( apply_filters( 'omega_online_store_breadcrumb_trail_items', $this->items, $this->args ) );
    }
